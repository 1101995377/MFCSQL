...
BEGIN_MESSAGE_MAP(CDatabaseGUIView, CRecordView)
	...
	ON_BN_CLICKED(CreateTalbebutton, OnCreateTalbebutton)
	ON_BN_CLICKED(DelNewtalbeButton, OnDelNewtalbeButton)
...
void CDatabaseGUIView::OnCreateTalbebutton() 
{
	// TODO: Add your control notification handler code here
	CDatabase db;
...
void CDatabaseGUIView::OnDelNewtalbeButton() 
{
	// TODO: Add your control notification handler code here
	CDatabase db;
	try
